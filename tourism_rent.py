...
def tourism_rent():
    ...
    with tab1:
        ...
        draw_st_choropleth_map(tourism, color='Blues', contrast=1.2, legend_num=10, legend_points=1)
    ...
    with tab2:
        ...
        draw_st_choropleth_map(rent, color='Purples', legend_num=10, legend_points=1)
        st.dataframe(rent)
